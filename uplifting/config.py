...
class BaseConfig(object):
    def __init__(self):
        ...
        self.tabletoken_mode = (
            "dynamic"  # ['originalmethod' , 'dynamic', 'dynamicAnkle']
        )
...
class TrainConfig(BaseConfig):
    def __init__(self, lr, name, size, debug, folder, exp_id=None):
        ...
        self.randomize_std = 5  # std deviation (in pixels) for randomizing detections
        ...
        self.tablemiss_prob = 0.05  # probability to simulate missing court detections
        self.bouncemiss_prob = 0.10  # probability to simulate missing bounce
